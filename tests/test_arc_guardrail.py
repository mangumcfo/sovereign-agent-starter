...
A fail-open-class boundary: a regression letting allow_autorun=True past KM's gate would auto-execute
...
def test_dormant_unless_activated():
    """Eligible + ratified + cadence-ok but NOT activated ⇒ still no auto-run (KM's standing choice)."""
