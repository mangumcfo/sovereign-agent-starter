"""/goal Scout packet-lint — the anti-slop gate (the ratified Scout synthesis spec (2026-06-15), §3/§4).

Proves the lint mechanically REJECTS slop, that earned-Green requires the evidence to RESOLVE (the
confident-but-wrong catch — the peer's kill-line condition), and that a clean packet passes.
"""
import sys
