...
carrying an inner ': ' is auto-repaired (GB's file untouched) and flagged degraded; an unparseable tail
...
def test_unquoted_inner_colon_is_auto_repaired():
    # the GB gotcha: an unquoted value carrying ': ' breaks strict YAML
