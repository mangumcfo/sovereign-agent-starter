...
(audit 2026-06-16 #8/M1, GB [369] refinement #1). Curated, not auto-generated: each entry is a real
...
# Refinement #1 (GB [369]) — substrate-lazy conditional imports: present ONLY when the sealed substrate
