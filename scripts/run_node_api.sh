...
# Which ledger the live node serves. Default = the Tiger<->G coordination ledger (real obligations).
export OBLIGATION_LEDGER_ROOT="${OBLIGATION_LEDGER_ROOT:-$HERE/memory/obligations/tiger_coordination}"
