...
# are a separate KM-gated commit. Reproducible: same code -> same candidate set (the upgrade over an LLM
...
echo
echo "Report-only. Removals/fixes = a separate KM-gated commit (re-run 279 suite + ledger equivalence snapshot)."
