...
permission-bypassed cron agents. "Everything in Atrium. One human gate only." (KM 2026-06-12.)
  ...
  · Adversarial review (Lane 3) — when a commit touches primitives/adapter, the git hook appends a trigger
    ...
    ("adversarial crypto review pending — primitives changed") for KM to disposition; running the review is
...
No agents are spawned here — it only mints cards. KM's Accept is what authorizes a review to run.
