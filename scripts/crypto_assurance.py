#!/usr/bin/env python3
"""
crypto_assurance.py — the daily assurance roll-up (crypto cadence, GB design + G framing, KM 2026-06-12).
...
chip + receipt, no queue noise); RED mints a gating obligation card so KM disposes the only thing that matters.
