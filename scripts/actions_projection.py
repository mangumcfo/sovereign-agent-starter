#!/usr/bin/env python3
"""
actions_projection.py — R22-2 Queryable `.actions[]` Projection over Merkle (the peer spec 2026-06-12).
...
Usage:
  python3 scripts/actions_projection.py [--type credit] [--principal the owner] [--obligation ID]
