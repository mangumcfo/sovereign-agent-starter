...
Audit 2026-06-13 (peer review [279]/[280]): the single-resolver + by_owner-from-replay fixes are INSTANCES of a
...
vice-versa). That is the exact disease behind the operator's 42 dropped comments — a projection out-truthing the
...
def check_parity(root, led=None) -> dict:
    ...
    # An open-but-approved card is awaiting execution, not the operator — correctly not surfaced.
