"""/goal Scout — on-demand trigger (the operator [378] #3). Owner-gated; mirrors /produce: fires the DETERMINISTIC,
...
def scout_run():
    ...
    posts candidate proposals the operator disposes. Fires only on this owner request; not an autonomous daemon."""
