...
def obligations_approve(obligation_id: str):
    ...
    Owner-gated (audit 2026-06-13 W5 #1): approve() clears the operator's constitutional breath-gate and records
    `approved_by`, so it must carry the SAME authority as /feedback/disposition, /proposals/decide,
    /apply. A non-owner (dev/loopback/federation peer) can no longer dispose the operator's material obligations.
