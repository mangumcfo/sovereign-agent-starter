...
# Not in the sealed 21-route contract_v1.yaml — flagged for KM/spec ratification.
# ============================================================================
...
def audit_evidence_bundle():
    ...
    bundle["_contract_note"] = ("contract_v1.1 extension (not in sealed v1.0 21-route "
                                "contract); flagged for KM/spec ratification.")
...
def invariants_status():
    ...
    return jsonify({
        ...
        "note": note,
        "_contract_note": "contract_v1.1 extension; flagged for KM/spec ratification.",
    })
