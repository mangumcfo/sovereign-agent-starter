...
Shape (GB's leaf_log -> segment_root -> checkpoint_root -> global_commitment):
...
Refinement (GB [351] #1): recompute the FULL right frontier each append, INCLUDING self-paired odd
