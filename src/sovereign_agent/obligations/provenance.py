...
def _assert_source_ref_resolves(source_ref: str) -> None:
    """R22-3 provenance rule (the peer): a path-like `source_ref` MUST resolve — the file exists, and if a
    ...
    # Compound ref (audit 2026-06-13 W5 #6): the peer feed refs are "<path> + <annotation> + …" where the
