...
node, on its OWN storage root — fully self-contained, never touching the live Tiger cylinder chain.
...
class ObligationLedger:
    ...
    def approve(self, obligation_id: str, approved_by: str,
        ...
        self._require(obligation_id)  # audit guard: no orphan approvals
    ...
    def reopen(self, obligation_id: str, reason: str, reopened_by: Optional[str] = None) -> dict:
        ...
        [245]: reopened the 42 KM comments closed without disposition so ledger + sittings speak one truth)."""
