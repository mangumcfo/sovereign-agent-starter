"""ARC guardrail demo — proves the card-first, dormant guardrail (the operator's choice: build, don't auto-run).
...
GREEN = {"id": "obl_green_1", "title": "Refresh the obligations master index", "owner": "peer",
         "classification": "C2", "material": False}
RED = {"id": "obl_red_1", "title": "FEC · propose_pooled_order (material)", "owner": "the owner",
...
def main():
    print("ARC guardrail demo — the operator choice: BUILD, do NOT activate (dormant).\n")
    ...
    print("\n3) Eligible + card-ratified, but ARC DORMANT (the operator's standing choice) — still no auto-run:")
    ...
    print("\n5) Hypothetical: if the operator activated ARC AND card-ratified AND cadence holds — only then:")
